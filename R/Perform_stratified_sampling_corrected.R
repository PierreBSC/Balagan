...
Perform_stratified_sampling_simulation_2 = function(sce,tiff_file,panel_file,N_simulations=30,N_FoV=10,FoV_size=100,type_stratification="Neyman",type_thresholding="Cumsqrt",
